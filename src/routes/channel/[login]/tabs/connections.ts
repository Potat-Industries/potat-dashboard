export const conns = [
  ...
  {
    description: 'By connecting your Discord account, you allow PotatBotat to view your username and ID.',
    icon: 'https://cdn.prod.website-files.com/6257adef93867e50d84d30e2/636e0a69f118df70ad7828d4_icon_clyde_blurple_RGB.svg',
    name: 'Discord',
    color: '#5865F2',
  },
  {
    description: 'By connecting your Spotify account, you allow PotatBotat to view your username and ID, view Spotify listening history, and control playback.',
  ...
  {
    description: 'By connecting your Steam account, you allow PotatBotat access to your Steam friend code, and publicly display it.',
    icon: 'https://steamcommunity.com/favicon.ico',
    name: 'Steam',
    color: '#1b2838',
  },
  {
    description: 'By connecting your Kick account, you allow PotatBotat to view your username and ID.',
